...
class CityChoiceComponent extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  getSelectedFromProps(props) {
    ...
    if (props.value === null && props.option.length !== 0) {
      selected = props.options[0].valueField;
    } else {
          ...
          <div className="row">
            <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
              {this.props.stepNumber === 2 && (
                <p style={intro}>What city do you reside in?</p>
              )}
              {this.props.stepNumber === 4 && (
                <p style={intro}>What city would you like to live in?</p>
              )}
              <Cities
                label="States"
              ...
              {this.state.selected === "" && this.props.stepNumber === 2 && (
                <div style={hidden_button}></div>
              )}
              {this.state.selected !== "" && (
                <p style={result_text}>{this.state.selected}</p>
              )}
              <div style={buttons_overlay}>
                {this.props.stepNumber === 4 && (
                  <div style={previous_button_overlay}>
                    <i
                      className="fa fa-arrow-left arrow-button"
                ...
                {this.checkIfCityExists() && (
                  <div style={next_button_overlay}>
                    {
                      <i
                        className="fa fa-arrow-right arrow-button"
