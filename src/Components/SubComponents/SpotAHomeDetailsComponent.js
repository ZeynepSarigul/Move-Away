      ...
      <div className="full-screen-banner">
        <div className="return-section">
          <div
            ...
            onClick={this.props.closeSpotAHomeDetails}
          >
            <button style={continue_button}>
        ...
        <div className={image_container_class}>
          <div>
            <div className="header-title">
              Discover {housing_number} of mid to long term housing options in{" "}
              {this.props.newCity} with{" "}
              <span style={{ fontWeight: "700" }}>Spotahome</span>, one of the
              largest online direct booking platforms that currently operates in
              16 cities <span style={{ fontWeight: "600" }}>worldwide</span>.
            </div>
            <div
            ...
            >
              <a
                href={"https://www.spotahome.com/" + city_url}
                target="_blank"
