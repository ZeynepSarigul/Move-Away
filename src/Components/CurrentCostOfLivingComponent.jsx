            ...
            <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
              <p style={intro}>
                ...
                <span
                  ...
                  data-tooltip="The comparison assumes net earnings after income tax!"
                >
                  {" "}
                  annual{" "}
                </span>{" "}
              ...
              <div style={input_overlay}>
                <select
                  ...
                  onChange={this.props.onChangeOfCurrencyType}
                >
              ...
              <p style={result_text}>
                Result: {this.props.currencyValue} {this.props.value}
              </p>
